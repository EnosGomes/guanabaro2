...
export class EmpresaService {
  ...
  create(empresa:Empresa): Observable<any> {
    ...
    return this.httpClient.post(this.apiURL + '/empresas', JSON.stringify(empresa), this.httpOptions)
  ...
  update(id:number, empresa:Empresa): Observable<any> {
    ...
    return this.httpClient.put(this.apiURL + '/empresas/' + id, JSON.stringify(empresa), this.httpOptions)
